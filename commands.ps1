...
#Connect-VIServer vcenterprimary.srv.hcvlny. -User root -Password r00t123
#Connect-VIServer -Server vcenterprimary.srv.hcvlny. -User ddilwort -Password 
...
#Import-vApp -Source d:\ISO_IMAGES\RHEL6480GB\RHEL6480GB.ovf -Name vdhcp-af.srv.hcvlny. -VMHost cld3-c3-b8.srv.hcvlny.
...
#Add hard disk
#New-HardDisk -VM acpdb2.srv.hcvlny. -CapacityGB 100 -Datastore smapp_os06

#Increase memory to 32GB
#Set-VM -VM acpdb2.srv.hcvlny. -MemoryGB 32

Configure New Esxi host

#Set Hostname, domainname, DNS Servers , DNS Search Domain
#Get-VMHostNetwork -VMHost 192.168.1.4| Set-VMHostNetwork -Hostname esx2 -DomainName srv.hcvlny. -DNSAddress 167.206.7.3 , 167.206.112.4 -SearchDomain srv.hcvlny., hcvlny., 

#NTP Configuration
# Add ntp servers
#Add-VMHostNTPServer -NtpServer time1., time2.  -Confirm:$false
...
#Configure SNMP
#$expression = "perl ""C:\Program Files (x86)\VMware\VMware vSphere CLI\bin\vicfg-snmp.pl"" --server cld3-c10-b1.srv.hcvlny. --username root --password r00t123 --show"
#Invoke-expression $expression
#$expression = "perl ""C:\Program Files (x86)\VMware\VMware vSphere CLI\bin\vicfg-snmp.pl"" --server cld3-c10-b1.srv.hcvlny. --username root --password r00t123 -c 'public,vmware'"
#Invoke-expression $expression
#$expression = "perl ""C:\Program Files (x86)\VMware\VMware vSphere CLI\bin\vicfg-snmp.pl"" --server cld3-c10-b1.srv.hcvlny. --username root --password r00t123 -t '172.16.30.111@162/public,172.16.30.111@162/vmware'"
#Invoke-expression $expression
# $expression = "perl ""C:\Program Files (x86)\VMware\VMware vSphere CLI\bin\vicfg-snmp.pl"" --server cld3-c10-b1.srv.hcvlny. --username root --password r00t123 -p 161"
#Invoke-expression $expression
$expression = "perl ""C:\Program Files (x86)\VMware\VMware vSphere CLI\bin\vicfg-snmp.pl"" --server cld3-c10-b1.srv.hcvlny. --username root --password r00t123 --enable"
Invoke-expression $expression
$expression = "perl ""C:\Program Files (x86)\VMware\VMware vSphere CLI\bin\vicfg-snmp.pl"" --server cld3-c10-b1.srv.hcvlny. --username root --password r00t123 --show"
Invoke-expression $expression
...
Remove-VDSwitchVMHost -vmhost cld3-c10-b1.srv.hcvlny. -VDSwitch "CLD3-ACCSW1-2.VSF1_dvSwitch"

#Add a host to a VDS
#Add-VDSwitchVMHost -vmhost cld3-c10-b1.srv.hcvlny. -VDSwitch "CLD3-ACCSW1-2.VSF1_dvSwitch"
#$NetworkAdapter = Get-VMHost -Name cld3-c10-b1.srv.hcvlny. | Get-VMHostNetworkAdapter `
# -Name vmnic3 -Physical
#Add-VDSwitchVMHost -vmhost cld3-c10-b1.srv.hcvlny. -VDSwitch "CLD3-ACCSW1-2.VSF1_dvSwitch"


#Take a host out of Mintenance mode
Set-VMHost -VMhost “cld3-c10-b1.srv.hcvlny.” -State “Connected”
for ($i=1; $i -le 3; $i++){
Connect-VIServer -Server cld3-c10-b$i.srv.hcvlny. -User root -Password r00t123
Set-VMHost -VMhost cld3-c10-b$i.srv.hcvlny. -State “Connected”
}
